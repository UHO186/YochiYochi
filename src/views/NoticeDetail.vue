<template>
    <div id="wrap">
        <div id="content">
            ...
            <div class="px-4 py-3 mt-2 border-2 rounded-lg border-yellow-300">
                ...
                <div class="px-32 py-5 bg-green-50">
...
export default {
    data() { //변수생성
        return {
            ...
            read_to: 1557,
            content: 'uhahagheqwehrqewrhsrfqweahewqerhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh',
            notice_list: '',
        }
    },
    mounted() {
    ...
    methods: {
        async getData() {
            await axios.get("http://localhost/api/board/1"
            ).then((res) => {
            ...
            console.log(URLSearch.get('index'))
        },
